...
export default function ClientInitAnimate({ children }) {
  ...
  return (
    <div className="nextjs-container min-w-[1080px] h-screen">{children}</div>
  );
}
